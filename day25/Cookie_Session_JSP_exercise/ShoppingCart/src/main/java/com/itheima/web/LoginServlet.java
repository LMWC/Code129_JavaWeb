    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if(loginUser==null){
                ...
                response.setHeader("refresh","3;url=http://localhost/login.jsp");
            }else{
                ...
                if(rem!=null && rem.equals("on")){
                    ...
                    Cookie cookie2 = new Cookie("password", URLEncoder.encode(user.getPassword()));
                ...
                response.setHeader("refresh","3;url=http://localhost/goods.jsp");
            }
